...
var SimpleTransactionIndexHelper = /** @class */ (function () {
    ...
    SimpleTransactionIndexHelper.prototype.getAll = function (reverse, limit, offset) {
        var promise = this._index.getAll(reverse, limit, offset);
        return exports.ErrorCatcher ? promise.catch(exports.ErrorCatcher) : promise;
    };
    SimpleTransactionIndexHelper.prototype.getOnly = function (key, reverse, limit, offset) {
        var promise = this._index.getOnly(key, reverse, limit, offset);
        return exports.ErrorCatcher ? promise.catch(exports.ErrorCatcher) : promise;
    };
    SimpleTransactionIndexHelper.prototype.getRange = function (keyLowRange, keyHighRange, lowRangeExclusive, highRangeExclusive, reverse, limit, offset) {
        var promise = this._index.getRange(keyLowRange, keyHighRange, lowRangeExclusive, highRangeExclusive, reverse, limit, offset);
        return exports.ErrorCatcher ? promise.catch(exports.ErrorCatcher) : promise;
    };
...
var SimpleTransactionStoreHelper = /** @class */ (function () {
    ...
    SimpleTransactionStoreHelper.prototype.getOnly = function (key, reverse, limit, offset) {
        var promise = this._store.openPrimaryKey().getOnly(key, reverse, limit, offset);
        return exports.ErrorCatcher ? promise.catch(exports.ErrorCatcher) : promise;
    };
    SimpleTransactionStoreHelper.prototype.getRange = function (keyLowRange, keyHighRange, lowRangeExclusive, highRangeExclusive, reverse, limit, offset) {
        var promise = this._store.openPrimaryKey().getRange(keyLowRange, keyHighRange, lowRangeExclusive, highRangeExclusive, reverse, limit, offset);
        return exports.ErrorCatcher ? promise.catch(exports.ErrorCatcher) : promise;
    };
