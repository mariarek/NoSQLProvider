    ...
    WebSqlProvider.prototype.open = function (dbName, schema, wipeIfExists, verbose) {
        ...
        if (oldVersion !== this._schema.version) {
            ...
            this._db.changeVersion(this._db.version, this._schema.version.toString(), function (t) {
                ...
                deferred.reject(err.message + (errorDetail_1 ? ', Detail: ' + errorDetail_1 : ''));
            }, function () {
            ...
            this.openTransaction([], true).then(function (trans) {
                ...
                deferred.reject(err.message + (errorDetail_2 ? ', Detail: ' + errorDetail_2 : ''));
            });
        }
        else {
            deferred.resolve(void 0);
        }
        return deferred.promise().then(function () { return changeVersionDeferred ? changeVersionDeferred.promise() : undefined; });
    };
